...
| 3 Documents wave | done 2026-09-17, released v0.3.0 and v0.3.1 | every document format read (PDF, Office, OpenDocument, EPUB, RTF, spreadsheets, notebooks, BibTeX, email, config, images, legacy Office), terms and concepts, named quantities, bibliography parsing; see `docs/phases/phase-3.md` |
