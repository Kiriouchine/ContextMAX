...
| 3 Documents wave | in progress (sessions 1-2 of 4 done: PDF, BibTeX, notebooks, RST, AsciiDoc, Org, email, config files, Word, PowerPoint, OpenDocument, EPUB, RTF, images, legacy Office) | spreadsheets and parameters, terms and concepts, bibliography parsing; see `docs/phases/phase-3.md` |
